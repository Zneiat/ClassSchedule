...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.BnavTabUnselect));
        addView(mIcon);
    }
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.BnavTabUnselect));
        }
    }
